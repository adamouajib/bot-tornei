...
- `:1v1 @member` starts a Ruby wager duel. When the challenged member accepts, the bot creates a private thread containing both players; they choose any map themselves, and winning the duel awards Ruby only (no winner role).
